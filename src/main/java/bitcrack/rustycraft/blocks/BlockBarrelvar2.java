...
public class BlockBarrelvar2 extends Block {
	
	private static final AxisAlignedBB BOUNDING_BOX = new AxisAlignedBB(0, 0, 0, 0.0625 * 16, 0.0625 * 23, 0.0625 * 16);

	public BlockBarrelvar2() {
		super(Material.ANVIL);
		setUnlocalizedName(Reference.RustycraftBlocks.BARRELVAR2.getUnlocalizedName());
		setRegistryName(Reference.RustycraftBlocks.BARRELVAR2.getRegistryName());
		setHardness(5F);
