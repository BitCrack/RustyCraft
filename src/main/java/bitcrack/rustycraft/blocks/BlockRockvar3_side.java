...
public class BlockRockvar3_side extends Block {

	private static final AxisAlignedBB BOUNDING_BOX = new AxisAlignedBB(0, 0, 0, 0.0625 * 16, 0.0625 * 24, 0.0625 * 16);
	public static final PropertyDirection FACING = BlockHorizontal.FACING;

	public BlockRockvar3_side() {
		super(Material.ROCK);
		setUnlocalizedName(Reference.RustycraftBlocks.ROCKVAR3_SIDE.getUnlocalizedName());
		setRegistryName(Reference.RustycraftBlocks.ROCKVAR3_SIDE.getRegistryName());
		setHardness(5F);
