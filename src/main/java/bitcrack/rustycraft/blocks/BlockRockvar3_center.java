...
public class BlockRockvar3_center extends Block {

	private static final AxisAlignedBB BOUNDING_BOX = new AxisAlignedBB(0, 0, 0, 0.0625 * 16, 0.0625 * 32, 0.0625 * 16);

	public BlockRockvar3_center() {
		super(Material.ROCK);
		setUnlocalizedName(Reference.RustycraftBlocks.ROCKVAR3_CENTER.getUnlocalizedName());
		setRegistryName(Reference.RustycraftBlocks.ROCKVAR3_CENTER.getRegistryName());
		setHardness(5F);
