...
public class BlockRockvar2_center extends Block {

	private static final AxisAlignedBB BOUNDING_BOX = new AxisAlignedBB(0, 0, 0, 0.0625 * 16, 0.0625 * 32, 0.0625 * 16);

	public BlockRockvar2_center() {
		super(Material.ROCK);
		setUnlocalizedName(Reference.RustycraftBlocks.ROCKVAR2_CENTER.getUnlocalizedName());
		setRegistryName(Reference.RustycraftBlocks.ROCKVAR2_CENTER.getRegistryName());
		setHardness(5F);
